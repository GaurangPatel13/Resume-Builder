      ...
      <Stack p={{ xs: "15px", sm: "25px", md: "40px", lg: "60px " }}>
        ...
        >
          ...
          >
            ...
            resume instantly. Create a professional resume in minutes with sample
        ...
        <Box mt="25px">
          ...
          <Box className="icons">
            ...
            <Link to="https://www.linkedin.com/in/gaurang-patel-8164492a3/" target="_blank">
              <LinkedInIcon
                sx={{ fontSize: "40px", paddingLeft: "15px" }}
                color="primary"
              />
            ...
            <Link to="https://github.com/gaurangpatel13/" target="_blank">
              <GitHub
